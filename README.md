...
#### 사용 스키마 이름 : cm_shopdb
#### jpa로 테이블 자동생성
##### 현제 상품등록 , 장바구니 , 키워드 , 로그인등의 사용자기능 들은 db 연결이 되어있습니다.
##### ===============================================================
...
##### -회원가입시 이메일 인증 기능
##### -로그인 , 로그아웃
##### -통합 인증 가입,로그인 기능 (현제는 카카오만 가능합니다.)

#### ====상품 등록====

##### -판매자 도는 관리자 일경우 메인화면 유저 메뉴에서 상품등록 가능
##### -상품 등록시 제목 , 설명 , 사진등록 및 메인사진 선택 , 상품타입 선택 , 상품 테그 선택 , 가격 등록가능 (사진 등록 기능이 조금 불안정합니다.)
...
##### -상품 목록에서 '담기' 버튼으로 상품 등록가능 , 등록된 상품은 타입에 따라 장바구니에 배치됨
##### -상품 의 수량을 선택할수있고 해당 수량에 맞춰서 최종 가격을 표시해주는 기능
##### -장바구니 목록에서 또는 상품목록에서 '제거'버튼을 클릭시 장바구니에 담긴 상품을 제거

#### ====구매 페이지====
##### -상품의 수량 설정 , 제거 , 상세보기 기능
##### -구매 상품의 가격합계 결과를 표시해주는 기능
##### -카카오 페이로 결제 테스트 구현
##### -결제 성공 여부에따른 페이지 구현

#### ====게시판====
##### -질문 게시판에 게시글 작성 및 수정 , 삭제 기능
##### -질문 게시글에 댓글 추가,삭제 기능
##### -질문 게시글의 댓글에 좋아요/싫어요 기능
##### -게시글의 유형을 '공지'로 변경하여 메인 화면의 공지 사항에 표시되게 했습니다.
